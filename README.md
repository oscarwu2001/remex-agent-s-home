...
- **Plant the gardens:** click one of the two green islands and press **Plant**. Choose tulips, daisies, lavender, a rose bush, a shrub, a small tree, a lamp post, stepping stones or a bench, or a big tree, blossom tree or fountain (these take 2 × 2 tiles). Then click the tiles where you want them. **Dig up** removes a piece. Your choices are saved in `%APPDATA%\Agents Home\decor.json`.
...
- **Weather** (in Settings): clear, cloudy, rain, snow or fog, or **Changes through the day**, which picks new weather every three hours (snow in winter, rain otherwise). Rain and snow fall over the hospital and the sun hides behind the clouds. The app stays offline, so it cannot read the real weather outside, and it shows no temperature. The time, the part of the day and the weather are shown at the bottom right of the map.
